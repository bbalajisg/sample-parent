 ...
 */
package com.st.common.business;
 ...
 *          </p>
 */
public interface SampleTableManager {
...
//	SampleTableEntity findSampleTable(String id);
	...
	List<SampleTable> listSampleTable();



	String insertSampleTable(SampleTable sampleTable);

	List<SampleAccessMatrix> listSampleAccessMatrices();
